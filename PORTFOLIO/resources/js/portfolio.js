        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                portfolioView({
                    ...
                    project_brief: `HAND CRICKET is a everyone's favorite childhood game which is played between two persons with the use of hands to know more look down`,

                    project_date: "2022",
                    project_client: "SPHN MINOR",
                    project_link: `www.${website}.com`,


                    image: [
                        "resources/img/uday1.mp4",
                ...
                portfolioView({
                    ...
                    project_date: "2019",
                    project_client: `${card.querySelector(".title").textContent
                        } Corporation`,
                    project_link: `www.${website}.com`,
